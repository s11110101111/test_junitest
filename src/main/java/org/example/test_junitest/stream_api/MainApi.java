...
public class MainApi {
    ...
    static {
        ...
        Stream<String> sString = Arrays.asList("Java", "C++", "Pyton", "ruby", "java",
            "Hello World").stream();
        ...
        Stream<String> s1 = Stream.of(arrStr);
        mapStream.put("streamArrayString", s1);
//add of char cast intstream
        ...
        Stream<Object> object = Stream.builder().add("bb1").add("bb2").add("bb3").add("bb4")
            .add("bb4").build();
// iterator
...
//не полетит так
// как стримы закончились
        //   Stream<?> stream1 = getStream("streamArrayString");
        //      stream1.map(s->s.toString().toUpperCase() ).forEach(System.out::println);
